...
export default function ProjectPage(){
    ...
    return(
        <>
            <Title order={2} mt={40} sx={{textAlign:'center', fontSize:35, marginBottom:0}} px={40}>🧑🏼‍💻 Personal Projects</Title>
            <Center>
                <Text px={50} maw={500} size='lg' style={{textAlign:'center'}}>Below are all of the personal projects that I believe show either substantial understanding or provide either impressive or interesting work.</Text>
            </Center>
            <Container py={75}>
