...
export const ProjectItem = ({title,description,image,id,technologies,isorganisation}:ProjectPost) => {
                ...
                <div className={styles.description}>
                  ...
                  <Stack spacing={0} mb="md">
                      ...
                      <Title order={2} style={{margin:0}}>
                        <Anchor sx={{color:"rgb(60,60,60)"}} href={`${window.location.origin}/${isorganisation ?"organisation":"project"}/${title.replaceAll(" ", "-")}`}>{title}</Anchor>
                      </Title>
